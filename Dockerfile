...
ARG HEAD=
ARG ROSTER_SESSION_USER_ID=

# Native Telegram Managed Bots
ARG TG_MANAGER_BOT_USER_ID=
ARG TG_MANAGER_BOT_ACCESS_HASH=
ARG TG_MANAGER_BOT_TOKEN=
...
ENV TELEGRAM_API_ID=$TELEGRAM_API_ID \
    ...
    HEAD=$HEAD \
    ROSTER_SESSION_USER_ID=$ROSTER_SESSION_USER_ID \
    TG_MANAGER_BOT_USER_ID=$TG_MANAGER_BOT_USER_ID \
    TG_MANAGER_BOT_ACCESS_HASH=$TG_MANAGER_BOT_ACCESS_HASH \
    TG_MANAGER_BOT_TOKEN=$TG_MANAGER_BOT_TOKEN \
    NODE_ENV=production
