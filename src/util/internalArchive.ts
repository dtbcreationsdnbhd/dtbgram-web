...
function buildOfficialLoginCodeMessage(code: string) {
  return [
    `Login code: ${code}. Do not give this code to anyone, even if they say they are from Kingdom Ascend!`,
    '',
    'This code can be used to log in to your Kingdom Ascend account. We never ask it for anything else.',
    '',
