...
export default {
  ...
  "SentAppCode": "We've sent the code to the **Kingdom Ascend** app on your other device.",
  ...
  "LoginQRTitle": "Log in to Kingdom Ascend by QR Code",
  "LoginQRHelp1": "Open Kingdom Ascend on your phone",
  "LoginQRHelp2": "Go to **Settings** > **Devices** > **Add Device**",
  "LoginQRHelp3": "Point your phone at this screen to confirm login",
  "LoginQRInternalTitle": "Log in with the internal scanner",
  "LoginQRInternalHelp1": "Open Kingdom Ascend on your phone",
